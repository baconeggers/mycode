...
def main():
    ...
    # harvest the private key for all 3 servers
    mykey = paramiko.RSAKey.from_private_key_file("/home/student/.ssh/id_rsa")

    # loop across the collection credz
    for cred in credz.credz:
        ...
        # list the contents of each home directly
        sessin, sessout, sesserr = sshsession.exec_command("ls /home/"+cred.get("un"))

        # display output
        with open("results.log","a") as of:
            of.write("Output from user: "+cred.get("un")+"\n"+sessout.read().decode('utf-8'))
